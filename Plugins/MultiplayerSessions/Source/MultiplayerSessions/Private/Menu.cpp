...
void UMenu::MenuSetup(int32 NumOfPublicConnections, FString MatchOfType, FString PathToLobby)
{
...
void UMenu::OnCreateSession(bool bWasSuccessful)
{
	if (bWasSuccessful)
	{
		if (GEngine)
		{
			GEngine->AddOnScreenDebugMessage(-1, 5.f, FColor::Yellow, TEXT("Session Created"));
		}
